    ...
    <div class="search-box">
      <div class="form-inline">
        ...
        <div class="form-group">
          ...
          <select class="form-control" v-model="devClsCd" title="장비유형">
        ...
        <div class="form-group">
          ...
          <select class="form-control" v-model="devMdlCd" title="장비모델">
            <option value="all">{{ $t('all') }}</option>
            <option
              v-for="(devMdl, index) in devMdlList"
              :key="'devCls' + devMdl.devMdlCd + index"
        ...
        <div class="form-group">
          ...
          <select class="form-control" v-model="serverNm" title="외부서버명">
            <option value="all">{{ $t('all') }}</option>
            <option
        ...
        <div class="form-group">
          ...
          <select class="form-control" v-model="tranCd" title="송수신구분">
            <option value="all">{{ $t('all') }}</option>
        ...
        <div class="form-group">
          ...
          <select class="form-control" v-model="successYn" title="상태">
            <option value="all">{{ $t('all') }}</option>
