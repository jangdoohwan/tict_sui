  ...
  <div>
      ...
      <div class="form-row row">
        <div class="form-item width-100">
          ...
          <div class="input-group-button">
            <button type="button" class="btn btn-gray pull-right" @click="fnMakecertKey()">
              {{ $t('produce') }}
            </button>
          </div>
        </div>
    ...
    <div class="modal-footer">
      <div class="text-center">
        <button @click="fnConfirmAdd()" type="button" class="btn btn-pink">
          {{ $t('registration') }}
        </button>
...
export default {
  ...
  methods: {
    ...
    submit() {
      ...
      requestApi({
        url: '/online/iotOpenSvc/createOpenSvc',
        headers: {
          'X-MID': this.xMid
        },
        data: dataObj,
