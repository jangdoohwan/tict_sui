    ...
    <div class="form-horizontal">
      <div class="flex mt-3">
        ...
        <div class="width-80 form-check">
          ...
          <label for="emrgPopup" class="form-check-label ml-3" style="user-select: none">
            <input
              v-model="alarmData.emrgPopYn"
              type="checkbox"
              id="emrgPopup"
              class="form-check-input"
              true-value="Y"
              false-value="N"
            >
            <span class="form-check-sign"></span> 긴급 팝업
          </label>
        </div>
      </div>
      <div class="flex mt-3">
  ...
  methods: {
    ...
    fnOpenMsgPopup() {
      this.popup({
        ...
        title: this.$t('select-alarm-message'),
        width: '500',
        height: '378',
        data: {},
        callback: data => {
