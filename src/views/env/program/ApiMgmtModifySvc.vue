  ...
  methods: {
    ...
    submit() {
      ...
      if (
        ...
        this.confirm(this.$t('modifyYn'), this.fnCallModifyApi) // API 수정
      }
    },
    fnHeaderListChk(gubun) {
      // select Header 리스트 중 데이터 있는 항목만 저장
      ...
      // text Header 리스트 중 데이터 있는 항목만 저장
