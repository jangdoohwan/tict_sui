  ...
  <div>
    <div class="search-box">
      <div class="left form-inline">
        <div class="form-group">
          <span class="form-label mx-1">{{ $t('charSet') }}</span>
        </div>
        <div class="form-group">
          <select
            class="form-control"
    ...
    <div class="menu-container">
      <div class="sms-box row">
        ...
        <div class="col-md-8 menu-detail">
          <ul class="form-inbox">
            <li>
  ...
  methods: {
    ...
    submit() {
      ...
      if (
        ...
        (this.dataObj.menuCdNm && this.dataObj.menuCdNm.trim() === '')
      ) {
        this.alert(this.$t('menuNm-input-msg'), 'warning')
      } else this.confirm(this.$t('saveYn'), this.fnCallupdateApi)
    },
