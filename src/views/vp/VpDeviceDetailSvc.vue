    ...
    <div class="modal-body">
      ...
      <div class="form-row row">
        ...
        <div class="form-item col-sm-6">
          ...
          <input
            v-model="dataObj.vpDeviceVendor"
            type="text"
            class="form-control"
            disabled
          />
      ...
      <div class="form-row row">
        ...
        <div class="form-item col-sm-6">
          ...
          <input
            v-model="dataObj.vpDeviceStatus"
            type="text"
            class="form-control"
            disabled
          />
