...
export default {
  ...
  data() {
    return {
      ...
      colModelData: [
        ...
        { name: 'serverNm', index: 'serverNm', align: 'center' },
        {
          name: 'vpDeviceSeq',
          index: 'vpDeviceSeq',
          align: 'center',
        ...
        { name: 'vpDeviceId', index: 'vpDeviceId', align: 'center' },
        ...
        { name: 'devClsCdNm', index: 'devClsCdNm', align: 'center' },
  ...
  methods: {
    getIotVpServerList () {
      getCommonCodeByParentCdId({ parentCdId: 'GN00000366', xMid: this.xMid }).then(data => {
