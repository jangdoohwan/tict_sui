  ...
  <div>
    <div class="modal-body">
      ...
      <div class="btn-wrap text-right">
        <button @click="insertRowIpList()" type="button" class="btn btn-gray">
          {{ $t('ip-add') }}
        </button>
      </div>
...
export default {
  ...
  methods: {
    ...
    retrieveSolSvrNmDupl() {
      if (
        this.dataObj.serverNm == null ||
        this.dataObj.serverNm.trim() === ''
      ) {
