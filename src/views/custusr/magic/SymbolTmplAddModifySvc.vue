            ...
            >
              ...
              <td>
                ...
                <input
                  ...
                  placeholder="Default"
                  :disabled="
                    disabledInputs[attb.itemNmCd] &&
                      disabledInputs[attb.itemNmCd]['whereCd']
                  "
                />
              </td>
              <td>
                ...
                <template v-if="fnCheckImageItemNmCd(attb.itemNmCd)">
                  <div class="flex width-100 items-center">
                    ...
                    />
                    <label
                      :for="`input-file-${index}`"
                      class="btn btn-gray"
                      :disabled="
                        disabledInputs[attb.itemNmCd] &&
                          disabledInputs[attb.itemNmCd]['valueCd']
                      "
                    >
                      {{ $t('image-upload') }}
                    </label>
              ...
              <td>
                ...
                <select
                  ...
                  :disabled="
                    disabledInputs[attb.itemNmCd] &&
                      disabledInputs[attb.itemNmCd]['alignCd']
                  "
                >
                  <option
              ...
              <td>
                ...
                <input
                  ...
                  :disabled="
                    disabledInputs[attb.itemNmCd] &&
                      disabledInputs[attb.itemNmCd]['posXCd']
                  "
                />
              </td>
              <td>
                ...
                <input
                  ...
                  :disabled="
                    disabledInputs[attb.itemNmCd] &&
                      disabledInputs[attb.itemNmCd]['posYCd']
                  "
                />
              </td>
              <td>
                ...
                <color-picker
                  ...
                  :disabled="
                    disabledInputs[attb.itemNmCd] &&
                      disabledInputs[attb.itemNmCd]['fontColorCd']
                  "
                />
              </td>
              <td>
                ...
                <input
                  ...
                  :disabled="
                    disabledInputs[attb.itemNmCd] &&
                      disabledInputs[attb.itemNmCd]['fontSizeCd']
                  "
                />
              </td>
              <td>
...
export default {
  ...
  methods: {
    ...
    // 심볼템플릿 상세 등록, 수정 시 유효성 검사
    fnValidateData() {
      // 입력된 템플릿명 없는 경우
      if (!this.tmplData.tmplNm || this.tmplData.tmplNm.trim().length === 0) {
        this.alert(
          this.$t('lead-not-inputed').replace('$0', this.$t('template-name'))
        )
        return false
      }
      // 선택된 심볼 없는 경우
      ...
      if (!this.tmplData.svcCd || this.tmplData.svcCd.length === 0) {
        this.alert(
          this.$t('lead-not-choosed').replace('$0', this.$t('service'))
        )
        return false
      }
      // 선택된 장비유형 없는 경우
      if (!this.tmplData.devClsCd || this.tmplData.devClsCd.length === 0) {
        this.alert(
          this.$t('lead-not-choosed').replace('$0', this.$t('dev-type'))
        )
        return false
      }
      // 선택된 모델명 없는 경우
      if (!this.tmplData.devMdlCd || this.tmplData.devMdlCd.length === 0) {
        this.alert(
          this.$t('lead-not-choosed').replace('$0', this.$t('mdlMtMdlNm'))
        )
        return false
      }
      // 추가된 속성 없는 경우
      ...
      if (this.tmplData.attbList.find(a => a.itemNmCd === '')) {
        this.alert(
          this.$t('lead-not-choosed').replace('$0', this.$t('attribute'))
        )
        return false
      }
    ...
    fnImageUpload(event, index) {
      ...
      if (!event.target.files || event.target.files.length === 0) {
        ...
        !/\.(jpg|bmp|ico|gif|png)$/i.test(event.target.files[0].name)
      ) {
