  ...
  <div>
    <div class="search-box">
      <div class="left form-inline">
        ...
        <div class="form-group" v-show="isSystemAdmin">
    ...
    <div class="mb-2 btn-wrap text-right">
      ...
      <button type="button" class="btn btn-pink" @click="fnPwInit">
        {{ $t('initPw') }}
      </button>
      <button type="button" class="btn btn-pink" @click="fnUnlock">
        {{ $t('unlock') }}
      </button>
      <button type="button" class="btn btn-pink" @click="fnReleaseDmc">
        {{ $t('unLockDormancy') }}
      </button>
      <button type="button" class="btn btn-pink" @click="fnRejoin">
        {{ $t('rejoin') }}
      </button>
      <button type="button" class="btn btn-gray" @click="fnUnregi">
        {{ $t('unregisterd') }}
      </button>
    </div>
    <jqgrid
...
export default {
  ...
  computed: {
    isAdmin() {
      // GN00000038: 공통관리자, GN00000033: 서비스 담당자, GN00000034: 사업팀 담당자, GN00000035: 전국 담당자
      return (
        this.roleCdId === 'GN00000038' ||
        this.roleCdId === 'GN00000033' ||
        this.roleCdId === 'GN00000034' ||
        this.roleCdId === 'GN00000035'
      )
    },
    isSystemAdmin() {
  ...
  methods: {
    ...
    fnReleaseDmc() {
      ...
      this.confirm(this.$t('release-slp-check')).then(() => {
    ...
    fnRejoin() {
      ...
      this.confirm(this.$t('rejoin-check')).then(() => {
    ...
    fnUnregi() {
      ...
      this.confirm(this.$t('cust-unregi-yn')).then(() => {
