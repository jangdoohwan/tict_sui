  ...
  <div class="organization-container">
    <div class="organization-title">
      <div class="facility-tree-title mb-2">
        <h4 class="titH4">{{ $t('organizaionMgmt') }}</h4>
      </div>
  ...
  methods: {
    ...
    submit() {
      ...
      if (!this.fnBlankCheck(this.dataObj.orgNm)) {
        ...
        this.dataObj.orgOrder !== null &&
        this.dataObj.orgOrder !== '' &&
        this.dataObj.orgOrder.trim() === ''
      ) {
        this.alert(this.$t('orgOrder-trim-chk'), 'warning')
