...
export default {
  ...
  methods: {
    ...
    fnModOutSvr() {
      ...
      // 장비유형 선택하지 않은 경우
      if (this.dataObj.devClsCd === null || this.dataObj.devClsCd === '') {
