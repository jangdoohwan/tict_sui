  ...
  <div>
      ...
      <div class="form-row row">
        <div class="form-item col-sm-4 col-md-4 col-lg-4">
          ...
          <select v-model="dataObj.outSvrSeq" class="form-control">
            <option
              v-for="(item, index) in outSvrList"
              :key="'key' + index"
              :value="item.outSvrSeq"
        ...
        <div class="form-item col-sm-4 col-md-4 col-lg-4">
          ...
          <select
            v-model="dataObj.devClsCd"
            @change="fnGetDevMdlList(false)"
            class="form-control"
          >
            <option
              v-for="item in unique(devClsList, 'devClsCd')"
              v-bind:key="item.devClsCd"
              v-bind:value="item.devClsCd"
        ...
        <div class="form-item col-sm-4 col-md-4 col-lg-4">
          ...
          <select v-model="dataObj.devMdlCd" class="form-control">
            <option
              ...
              v-bind:key="item.devMdlCd"
              v-bind:value="item.devMdlCd"
            ...
            <div class="form-row row">
              <div class="form-item col-sm-12">
                ...
                <textarea
                  ...
                  cols="50"
                  rows="5"
                  v-model="dataObj.bodys"
                  v-if="this.dataObj.byPassYn === 'Y'"
                  disabled
                />
                <textarea
                  class="form-control"
    ...
    <div class="modal-footer">
      <div class="text-center btn-wrap">
        <button @click="fnAddDuplication()" type="button" class="btn btn-pink">
          {{ $t('registration') }}
        </button>
        <button
          @click="close()"
  ...
  data() {
    return {
      ...
      dataObj: {
        ...
        medth: 'GN00000239',
        heads:
          'content-type:#{content-type}\rx-apiversion:#{x-apiversion}\r\nx-auth:#{X-CERTKEY}\r\nx-logkey:#{x-logkey}\r\nx-commandtype:#{x-commandtype}\r\nx-lang:#{x-lang}\r\nx-channel:#{x-channel}\r\nx-uuid:#{x-uuid}\r\nx-vname:OUIF',
        headr:
          'content-type:#{content-type}\rx-apiversion:#{x-apiversion}\r\nx-auth:#{X-CERTKEY}\r\nx-logkey:#{x-logkey}\r\nx-commandtype:#{x-commandtype}\r\nx-lang:#{x-lang}\r\nx-channel:#{x-channel}\r\nx-uuid:#{x-uuid}\r\nx-vname:OUIF',
        head: '',
  ...
  methods: {
    ...
    confirmCallback() {
      ...
      if (this.dataObj.devClsCd === -1) {
        ...
        (this.dataObj.bodys === null || this.dataObj.bodys === '') &&
        this.dataObj.byPassYn !== 'Y' &&
        this.dataObj.tranCd !== 'GN00000237'
      ) {
