let envs = {
  ...
  framework: {
    env: process.env.VUE_APP_ENV || 'tict_default',
    ...
    whiteListWithLogin: ['/custusr/user/user', '/page'],
    chartColorSet: ['#003f5c', '#58508d', '#bc5090', '#ff6361', '#ffa600']
  },
  websocket: {
